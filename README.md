...
# Лицензия/License
#### ru:
Данный репозиторий содержит в себе полную копию репозитория [nginx](https://github.com/nginx/nginx), в целях демонстрации работы сборочного конвейнера.
Лицензия nginx: [BSD 2-clause license](src/nginx/LICENSE).

#### eng:
Current repository contains a full copy of [nginx](https://github.com/nginx/nginx) repository for the sake of pipeline demonstration.
nginx is licensed under [BSD 2-clause license](/src/nginx/LICENSE).
